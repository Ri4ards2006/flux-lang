...
| 0x09   | `OP_ADD`         | 0x09 | `[OP_ADD] [DstReg:1] [SrcReg:1]` *(uint32 wrapping addition)*     |
| 0x0A   | `OP_SUB`         | 0x0A | `[OP_SUB] [DstReg:1] [SrcReg:1]` *(uint32 wrapping subtraction)*  |
| 0x0B   | `OP_MUL`         | 0x0B | `[OP_MUL] [DstReg:1] [SrcReg:1]` *(uint32 wrapping multiplication)*|
| 0x0C   | `OP_DIV`         | 0x0C | `[OP_DIV] [DstReg:1] [SrcReg:1]` *(uint32 division; error if 0)*  |
| 0x0D   | `OP_AND`         | 0x0D | `[OP_AND] [DstReg:1] [SrcReg:1]` *(bitwise AND)*                  |
| 0x0E   | `OP_OR`          | 0x0E | `[OP_OR]  [DstReg:1] [SrcReg:1]` *(bitwise OR)*                   |
| 0x0F   | `OP_XOR`         | 0x0F | `[OP_XOR] [DstReg:1] [SrcReg:1]` *(bitwise XOR)*                  |
| 0x10   | `OP_SHL`         | 0x10 | `[OP_SHL] [DstReg:1] [SrcReg:1]` *(logical shift left)*           |
| 0x11   | `OP_SHR`         | 0x11 | `[OP_SHR] [DstReg:1] [SrcReg:1]` *(logical shift right)*          |
